...
"""
"""
ScatterLabs의 Meena Model 코드 입니다.
현재 해당 레포지토리는 삭제되었고, fork 되었던, Entekorea/dialogue-generation-models-1 내 코드를 가져왔습니다.
"""
import warnings
...
from .configuration_meena_v2 import MeenaConfig
...
class MeenaModel(PretrainedMeenaModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if encoder_outputs is None: # 인코더 출력 값이 없는경우
        ...
        elif return_dict and not isinstance(encoder_outputs, BaseModelOutput): # 인코더 출력이 BaseModelOutput과 다른 경우
